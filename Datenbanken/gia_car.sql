...
CREATE TABLE IF NOT EXISTS `tab_auto` (
...
CREATE TABLE IF NOT EXISTS `tab_klasse` (
...
CREATE TABLE IF NOT EXISTS `tab_marke` (
...
CREATE TABLE IF NOT EXISTS `tab_stellplatz` (
  `stellplatznr` int(11) NOT NULL,
  `Stellplatz` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`stellplatznr`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
