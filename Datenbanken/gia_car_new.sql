...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 28. Jan 2017 um 13:41
...
ALTER TABLE `tab_ausstattung`
  ...
  ADD KEY `AusstattungsNr` (`AusstattungsNr`);
...
--
-- Indizes für die Tabelle `tab_kunde`
--
...
--
-- AUTO_INCREMENT für Tabelle `tab_kunde`
--
ALTER TABLE `tab_kunde`
  MODIFY `KundenNr` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tab_auto`
  ADD CONSTRAINT `tab_auto_ibfk_1` FOREIGN KEY (`StellplatzNr`) REFERENCES `tab_stellplatz` (`stellplatznr`),
